...
import net.alternateadventure.brickforgery.screenhandler.AlloySmelterScreenHandler;
...
public class AlloySmelterBlock extends DirectionalMachineTemplateBlock {

    private final Random rand = new Random();
    private final boolean lit;
    private static boolean SETTING_TILE = false;

    public AlloySmelterBlock(Identifier identifier, Material material, float hardness, BlockSoundGroup blockSounds, boolean isLit) {
