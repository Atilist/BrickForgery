...
import net.alternateadventure.brickforgery.screenhandler.MetalworkingStationScreenHandler;
...
public class MetalworkingStationBlockTemplate extends LazySimpleMachineBlockTemplate implements MechanicalDevice {
    
    private final Random rand = new Random();
    public TierEnum tier;
    public MetalworkingStationBlockTemplate(Identifier identifier, Material material, float hardness, BlockSoundGroup blockSounds, TierEnum tier) {
