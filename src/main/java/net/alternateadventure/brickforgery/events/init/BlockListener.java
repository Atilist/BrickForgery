...
import net.alternateadventure.brickforgery.block.AlloySmelterBlock;
import net.alternateadventure.brickforgery.block.BrickCropBlock;
import net.alternateadventure.brickforgery.block.BrickForgeBlock;
import net.alternateadventure.brickforgery.block.BrickFrameAutomator;
import net.alternateadventure.brickforgery.block.BrickFrameCrafterBlock;
...
import net.alternateadventure.brickforgery.block.CryogenicHibachiBlock;
import net.alternateadventure.brickforgery.block.DesertPotBlock;
import net.alternateadventure.brickforgery.block.DesertPotSealedBlock;
import net.alternateadventure.brickforgery.block.DiamondOreBricksBlock;
import net.alternateadventure.brickforgery.block.DirectionalMachineTemplateBlock;
import net.alternateadventure.brickforgery.block.DoublePlantBlock;
import net.alternateadventure.brickforgery.block.DustBlock;
import net.alternateadventure.brickforgery.block.ExoticShrubBlock;
import net.alternateadventure.brickforgery.block.ExoticShrubDeadBlock;
import net.alternateadventure.brickforgery.block.FastBricksBlock;
import net.alternateadventure.brickforgery.block.FrostburnBlock;
import net.alternateadventure.brickforgery.block.FrozenPotBlock;
import net.alternateadventure.brickforgery.block.FrozenPotSealedBlock;
import net.alternateadventure.brickforgery.block.GoldOreBricksBlock;
import net.alternateadventure.brickforgery.block.HarvesterBlockTemplate;
import net.alternateadventure.brickforgery.block.HeatPillarBlock;
import net.alternateadventure.brickforgery.block.HeatPillarIgnitedBlock;
import net.alternateadventure.brickforgery.block.HeatPillarStokedBlock;
import net.alternateadventure.brickforgery.block.ImprovedMillstoneBlock;
import net.alternateadventure.brickforgery.block.IndestructibleBlockBlock;
import net.alternateadventure.brickforgery.block.IronOreBricksBlock;
import net.alternateadventure.brickforgery.block.LazyBlockTemplate;
import net.alternateadventure.brickforgery.block.LazySimpleMachineBlockTemplate;
import net.alternateadventure.brickforgery.block.MachineFrameBlock;
...
import net.alternateadventure.brickforgery.block.NightSaplingBlock;
import net.alternateadventure.brickforgery.block.NightWheatCropBlock;
import net.alternateadventure.brickforgery.block.PlintBricksBlock;
import net.alternateadventure.brickforgery.block.RedstoneOreBricksBlock;
import net.alternateadventure.brickforgery.block.ResourcePileBlock;
import net.alternateadventure.brickforgery.block.SandinatorBlock;
import net.alternateadventure.brickforgery.block.SlicerBlockTemplate;
import net.alternateadventure.brickforgery.block.SpikeMountBlock;
import net.alternateadventure.brickforgery.block.StoneBricksBlock;
import net.alternateadventure.brickforgery.block.SuperCaneBlock;
import net.alternateadventure.brickforgery.block.WasherBaseBlock;
import net.alternateadventure.brickforgery.block.WoodenBricksBlock;
