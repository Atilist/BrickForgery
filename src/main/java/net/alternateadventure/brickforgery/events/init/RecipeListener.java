...
public class RecipeListener {
    ...
    public void registerRecipes(RecipeRegisterEvent event) {
        ...
        if (type == RecipeRegisterEvent.Vanilla.CRAFTING_SHAPED.type()) {
            ...
            CraftingRegistry.addShapedRecipe(new ItemInstance(BlockListener.primitiveMachineFrame), "XYX", "Y#Y", "XYX", 'X', new ItemInstance(ItemListener.goldenScrew), 'Y', new ItemInstance(ItemListener.nightWoodBeam), '#', new ItemInstance(ItemListener.woodenFrame));
