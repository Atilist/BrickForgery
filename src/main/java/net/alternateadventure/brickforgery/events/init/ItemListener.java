...
import net.alternateadventure.brickforgery.item.ArchaeologyIceKnifeItem;
import net.alternateadventure.brickforgery.item.BrickCatalystItem;
import net.alternateadventure.brickforgery.item.BrickSeedlingsItem;
import net.alternateadventure.brickforgery.item.BrushToolTemplate;
import net.alternateadventure.brickforgery.item.ChiselToolTemplate;
import net.alternateadventure.brickforgery.item.DesertKeyItem;
import net.alternateadventure.brickforgery.item.DirtBrickSandItem;
import net.alternateadventure.brickforgery.item.ExoticCatalystItem;
import net.alternateadventure.brickforgery.item.ExoticKeyItem;
import net.alternateadventure.brickforgery.item.FernItem;
import net.alternateadventure.brickforgery.item.GrabberToolTemplate;
