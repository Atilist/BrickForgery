...
public class HeatPillarStokedBlock extends LazyBlockTemplate implements AffectedByBellows {
    public HeatPillarStokedBlock(Identifier identifier, Material material, float hardness, BlockSoundGroup blockSounds) {
