...
public class IndestructibleBlockBlock extends LazyBlockTemplate {
    public IndestructibleBlockBlock(Identifier identifier, Material material, float hardness, BlockSoundGroup blockSounds, float blastResistance) {
