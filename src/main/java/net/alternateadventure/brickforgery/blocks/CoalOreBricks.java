...
public class CoalOreBricks extends LazyBlockTemplate implements SpikeCrushable {
    public CoalOreBricks(Identifier identifier, Material material, float hardness, BlockSounds blockSounds) {
        super(identifier, material, hardness, blockSounds);
    }

    @Override
    public ItemInstance crushingOutput() {
        return new ItemInstance(ItemListener.coalOreBrick, 2);
    }
