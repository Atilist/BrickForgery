...
public class NightSaplingBlock extends TemplateBlock {

    public NightSaplingBlock(Identifier identifier, Material material) {
        super(identifier, material);
        setTickRandomly(true);
    }

    @Override
    public NightSaplingBlock setHardness(float Hardness) {
        return (NightSaplingBlock) super.setHardness(Hardness);
    }
