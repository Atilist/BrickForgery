...
public class NightWheatCropBlock extends TemplateBlock {

    public NightWheatCropBlock(Identifier identifier, Material material) {
    ...
    @Override
    public NightWheatCropBlock setHardness(float Hardness) {
        return (NightWheatCropBlock) super.setHardness(Hardness);
    }
