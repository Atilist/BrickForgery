...
public class FrostburnBlock extends LazyBlockTemplate {
    public FrostburnBlock(Identifier identifier, Material material, float hardness, BlockSoundGroup blockSounds) {
