...
public class DoublePlantBlock extends LazyBlockTemplate {
    public DoublePlantBlock(Identifier identifier, Material material, float hardness, BlockSoundGroup blockSounds) {
