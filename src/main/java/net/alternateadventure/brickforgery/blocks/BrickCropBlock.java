...
public class BrickCropBlock extends TemplateBlock {

    public BrickCropBlock(Identifier identifier, Material material) {
        super(identifier, material);
        setTickRandomly(true);
    }

    @Override
    public BrickCropBlock setHardness(float Hardness) {
        return (BrickCropBlock) super.setHardness(Hardness);
    }
