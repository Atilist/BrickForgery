...
public class FastBricksBlock extends LazyBlockTemplate {

    public FastBricksBlock(Identifier identifier, Material material, float hardness, BlockSoundGroup blockSounds) {
