...
//    public PrimitiveBrickFrameCrafter(Identifier identifier, Material material, float hardness, BlockSoundGroup blockSounds) {
...
//    }
//
//    public boolean decreaseClay (World level, int x, int y, int z)
//    {
...
//    }
//
//    public boolean decreasePlanks (World level, int x, int y, int z)
//    {
