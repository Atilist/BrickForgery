...
public class DesertPotBlock extends TemplateBlock {

    public DesertPotBlock(Identifier identifier, Material material) {
        super(identifier, material);
        setSoundGroup(Block.GLASS_SOUND_GROUP);
    }

    @Override
    public DesertPotBlock setHardness(float Hardness) {
        return (DesertPotBlock) super.setHardness(Hardness);
    }
